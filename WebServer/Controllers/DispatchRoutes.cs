...
public class DispatchRoutes
{
    ...
    [HttpGet("/hkrpg_global/mdk/shopwindow/shopwindow/listPriceTier")]
    public ContentResult ListPriceTier()
    {
        return new ContentResult
        {
            Content = "{\"retcode\":0,\"message\":\"OK\",\"data\":{\"suggest_currency\":\"CNY\",\"tiers\":[{\"tier\":\"1\",\"price\":\"6.00\",\"currency\":\"CNY\"},{\"tier\":\"2\",\"price\":\"30.00\",\"currency\":\"CNY\"},{\"tier\":\"3\",\"price\":\"98.00\",\"currency\":\"CNY\"},{\"tier\":\"4\",\"price\":\"198.00\",\"currency\":\"CNY\"},{\"tier\":\"5\",\"price\":\"328.00\",\"currency\":\"CNY\"},{\"tier\":\"6\",\"price\":\"648.00\",\"currency\":\"CNY\"}]}}",
            ContentType = "application/json"
        };
    }
	[HttpGet("/hkrpg_global/mdk/shopwindow/shopwindow/pay")]
    public ContentResult Pay()
    {
        // 这是一个简单的假支付界面，点击即代表充值成功
        return new ContentResult
        {
            Content = "<html><body><h1>模拟支付成功</h1><p>发货逻辑请在 GameServer 后台指令或 ShopService 中处理。</p></body></html>",
